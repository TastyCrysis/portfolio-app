...
const privacy = () => {
  return (
    <div className="p-2 max-w-[800px] m-auto">
      ...
      <h3 className="py-2">Datenerfassung auf dieser Website</h3>{" "}
      <h4 className="py-2">
      ...
      <h4 className="py-2">Wie erfassen wir Ihre Daten?</h4>{" "}
      <p className="py-2">
      ...
      <h4 className="py-2">Wof&uuml;r nutzen wir Ihre Daten?</h4>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>{" "}
      <p className="py-2">
      ...
      <h2 className="py-2">2. Hosting</h2>
      <p className="py-2">
        Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
      </p>
      <h3 className="py-2">Externes Hosting</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Datenschutz</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Hinweis zur verantwortlichen Stelle</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Speicherdauer</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Auskunft, L&ouml;schung und Berichtigung</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Recht auf Einschr&auml;nkung der Verarbeitung</h3>{" "}
      <p className="py-2">
      ...
      <h2 className="py-2">4. Datenerfassung auf dieser Website</h2>
      <h3 className="py-2">Cookies</h3>{" "}
      <p className="py-2">
      ...
      <h3 className="py-2">Server-Log-Dateien</h3>{" "}
      <p className="py-2">
